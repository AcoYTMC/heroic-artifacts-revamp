...
public interface RedemptionItems {
    ...
    Item QUARTZ_KATANA = ITEMS.register("quartz_katana", KatanaItem::new, new KatanaSettings()
    ...
    Item REDSTONE_KATANA = ITEMS.register("redstone_katana", KatanaItem::new, new KatanaSettings()
    ...
    Item AMETHYST_KATANA = ITEMS.register("amethyst_katana", KatanaItem::new, new KatanaSettings()
    ...
    Item COPPER_KATANA = ITEMS.register("copper_katana", KatanaItem::new, new KatanaSettings()
    ...
    Item LAPIS_KATANA = ITEMS.register("lapis_katana", KatanaItem::new, new KatanaSettings()
    ...
    Item NETHERITE_KATANA = ITEMS.register("netherite_katana", KatanaItem::new, new KatanaSettings()
    ...
    Item EMERALD_KATANA = ITEMS.register("emerald_katana", KatanaItem::new, new KatanaSettings()
    ...
    Item SCULK_KATANA = ITEMS.register("sculk_katana", KatanaItem::new, new KatanaSettings()
    ...
    // Misc
    Item COURT_GLASS = ITEMS.register("court_glass", CourtGlassItem::new, new KatanaSettings()
            .maxCount(1));

    Item HUNTERS_GLASS = ITEMS.register("hunters_glass", HuntersCourtGlassItem::new, new KatanaSettings()
            .maxCount(1));
