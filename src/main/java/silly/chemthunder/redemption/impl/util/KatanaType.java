...
public enum KatanaType implements StringIdentifiable {
    AMETHYST("amethyst",
            AMETHYST_KATANA,
//            AMETHYST_SHEATH, SHEATHED_AMETHYST_KATANA,
            StatusEffects.SPEED
    ),
    COPPER("copper",
            COPPER_KATANA,
//            COPPER_SHEATH, SHEATHED_COPPER_KATANA,
            StatusEffects.TRIAL_OMEN
    ),
    EMERALD("emerald",
            EMERALD_KATANA,
//            EMERALD_SHEATH, SHEATHED_EMERALD_KATANA,
            StatusEffects.HERO_OF_THE_VILLAGE
    ),
    LAPIS("lapis",
            LAPIS_KATANA,
//            LAPIS_SHEATH, SHEATHED_LAPIS_KATANA,
            StatusEffects.HASTE
    ),
    NETHERITE("netherite",
            NETHERITE_KATANA,
//            NETHERITE_SHEATH, SHEATHED_NETHERITE_KATANA,
            StatusEffects.STRENGTH, StatusEffects.RESISTANCE
    ),
    QUARTZ("quartz",
            QUARTZ_KATANA,
//            QUARTZ_SHEATH, SHEATHED_QUARTZ_KATANA,
            StatusEffects.FIRE_RESISTANCE
    ),
    REDSTONE("redstone",
            REDSTONE_KATANA,
//            REDSTONE_SHEATH, SHEATHED_REDSTONE_KATANA,
            StatusEffects.STRENGTH
    ),
    SCULK("sculk",
            SCULK_KATANA
//            , SCULK_SHEATH, SHEATHED_SCULK_KATANA
    ), // No effects
    ASHIRO("ashiro",
            ASHIRO_KATANA
//            , ASHIRO_SHEATH, SHEATHED_ASHIRO_KATANA
    ); // No effects
...
//    private final List<Item> items;
    ...
    KatanaType(String id, Item katana
//            , Item sheath, Item sheathed
            , RegistryEntry<StatusEffect>... effects) {
        this.id = id;
        this.katana = katana;
        //this.sheath = sheath;
